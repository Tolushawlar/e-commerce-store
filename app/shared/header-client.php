    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-30">
        <div class="flex flex-col h-full">
            ...
            <div class="p-6 border-b">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Client Panel</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                <a href="/client/dashboard.php" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary/10 text-gray-700 hover:text-primary mb-1">
                    <span class="material-symbols-outlined">dashboard</span>
                    <span class="font-semibold">Dashboard</span>
                </a>
                <a href="/client/stores.php" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary/10 text-gray-700 hover:text-primary mb-1">
                    <span class="material-symbols-outlined">store</span>
                    <span class="font-semibold">My Stores</span>
                </a>
                <a href="/client/products.php" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary/10 text-gray-700 hover:text-primary mb-1">
            ...
            <div class="p-4 border-t">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-900" id="userName">Client</p>
                        <p class="text-xs text-gray-500" id="userPlan">Standard Plan</p>
                    </div>
                </div>
